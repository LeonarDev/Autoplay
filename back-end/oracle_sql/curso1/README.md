...
Repositório de exercícios propostos pelo **[Curso 1](https://cursos.alura.com.br/course/oracle-database-sql-dml)** da Formação "SQL com Oracle Database" da **[Alura](https://www.alura.com.br/)**.
...
- Consultas com SELECT e filtros com WHERE
- Adicionando dados no banco com INSERT
- Atualizando e apagando dados com UPDATE e DELETE
- Estruturando tabelas com CREATE TABLE
